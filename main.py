...
def main():
    ...
    scheduler = MainScheduler(
        {
            "start_timepoints": starts,
            "end_timepoints": ends,
            "texts": texts,
            "img_dir": activated_schedule["img_dir"],
            'audio_dir_when_start': activated_schedule['audio_dir_when_start'],
            'audio_dir_when_end': activated_schedule['audio_dir_when_end'],
        }
    )
    sys.exit(app.exec())
